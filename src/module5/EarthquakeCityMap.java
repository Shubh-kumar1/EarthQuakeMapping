...
public class EarthquakeCityMap extends PApplet {
	...
	public void setup() {		
		...
		if (offline) {
			...
			map = new UnfoldingMap(this, 200, 50, 650, 600, new de.fhpotsdam.unfolding.providers.OpenStreetMap.OpenStreetMapProvider());
		}
	...
	private boolean isInCountry(PointFeature earthquake, Marker country) {
		...
		else if(((AbstractShapeMarker)country).isInsideByLocation(checkLoc)) { // TYPO FIXED HERE
			earthquake.addProperty("country", country.getProperty("name"));
			return true;
		}
		return false;
